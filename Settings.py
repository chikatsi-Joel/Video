...
class Profile(SmoothScrollArea) :
    def __init__(
        ...
        self.prof = Prof(path_image=path_name,  name=name, path_git = path_git, age= age, tokens = tokens, nbre_video = nbre_video, mail = mail, descript= descript)
        self.prop = A_propos()
        self.sys = SystemReq()
...
class Parametres(QWidget) :
    def __init__(
        ...
        self.prof = Profile(path_name=path_name,  name=name, path_git = path_git, age= age, tokens = tokens, nbre_video = nbre_video, mail = mail, descript= descript)
...
if __name__=='__main__' :
    ...
    ma = Parametres("Images/moi.png", "Joel", "https://beta.theb.ai/home", 500, "kappachikatsi@gmail.com", "Promotteur en chef du projet et Etudiant en licence 3 à l'université de Yaoundé 1")
    ma.show()
    app.exec()
